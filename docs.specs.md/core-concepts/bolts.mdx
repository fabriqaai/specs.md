...
specs.md currently supports three bolt types:
...
<AccordionGroup>
  ...
  <Accordion title="Use Spike Bolt when...">
    - Facing unknowns that need research
...
For research and exploration when facing unknowns:
...
<AccordionGroup>
  ...
  <Accordion title="Choose the Right Bolt Type">
    Use DDD for complex domain logic, Simple for UI/utilities, Spike for research. Don't over-engineer simple tasks.
  </Accordion>
