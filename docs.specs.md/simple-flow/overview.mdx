...
<Info>
**Independent Flows**: Simple Flow and AI-DLC are independent flows designed for different project types. Install one or the other based on your needs—not both. There is no "upgrade path" from Simple Flow to AI-DLC; choose the right flow for your project from the start.
</Info>
