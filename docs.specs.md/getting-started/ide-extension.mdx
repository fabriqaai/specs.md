...
The extension adapts to your selected flow:

### FIRE Flow Views

If you're using FIRE Flow, the extension shows:
...
If you're using AI-DLC Flow, the extension provides three main views:
