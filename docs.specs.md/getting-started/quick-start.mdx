---
title: Quick Start
description: Get up and running with specs.md in minutes
---
...
<Tabs>
  ...
  <Tab title="Cursor">
    Use the specs.md rule and type: `@specsmd-master-agent`
  </Tab>
...
<Warning>
  Human validation happens at each stage gate. This ensures errors are caught early before cascading downstream.
</Warning>
