...
<Info>
  **First, install specs.md in your project:**
  ```bash
  npx specsmd@latest install
  ```
  During installation, you'll select which AI development tools you use. The agent prompts will be available in the tools you selected.
</Info>
...
<Steps>
  ...
  <Step title="Human Validation">
    Agent pauses for approval at stage gates
  </Step>
