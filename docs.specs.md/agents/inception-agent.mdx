...
```mermaid
flowchart TB
    A[User Request] --> B[Clarifying Questions]
    B --> G1{Gate 1}
    G1 -->|User answers| C[Generate Requirements]
    C --> G2{Gate 2}
    G2 -->|User approves| D[Auto-Generate Artifacts]
    ...
    D4 --> G3{Gate 3}
    G3 -->|User approves| E[Ready for Construction?]
    E --> G4{Gate 4}
    G4 -->|User confirms| F[Route to Construction]
    ...
    style D1 fill:#818CF8,stroke:#6366F1,color:#fff
    style D2 fill:#818CF8,stroke:#6366F1,color:#fff
    style D3 fill:#818CF8,stroke:#6366F1,color:#fff
    style D4 fill:#818CF8,stroke:#6366F1,color:#fff
```
