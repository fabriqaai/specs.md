---
title: "Changelog"
description: "All notable changes to specs.md"
---

## Overview

This page tracks all notable changes to specs.md. For the raw changelog file, see [CHANGELOG.md on GitHub](https://github.com/fabriqaai/specs.md/blob/main/CHANGELOG.md).
