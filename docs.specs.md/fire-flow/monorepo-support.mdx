...
<Frame>
  <img src="/images/fire_monorepo.png" alt="FIRE Monorepo Detection" style={{ borderRadius: '8px' }} />
</Frame>

```mermaid actions={false}
flowchart TD
    subgraph "Project Root"
        R(.specs-fire/standards/):::build
        C(constitution.md):::design
        TS(tech-stack.md):::plan
    end

    subgraph "packages/api"
        A(.specs-fire/standards/):::build
        ATS(tech-stack.md - Go):::done
    end

    subgraph "packages/web"
        W(.specs-fire/standards/):::build
        WTS(tech-stack.md - React):::done
    end
