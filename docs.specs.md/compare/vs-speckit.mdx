...
**GitHub Spec Kit** is a toolkit that provides agent prompts and slash commands (`/speckit.specify`, `/speckit.plan`, `/speckit.tasks`) for 15+ AI coding assistants including Claude Code, Cursor, GitHub Copilot, and Gemini CLI.
...
| **Approach** | Structured AI-DLC phases with methodology | 4-phase workflow with agent prompts |
| **Structure** | Intents → Units → Stories | Specify → Plan → Tasks → Implement |
| **Agent Model** | 4 phase-based agents | Prompts for 15+ AI assistants |
...
**specs.md (AI-DLC)**: AI drives with Mob rituals
```
...
**specs.md (AI-DLC)**: DDD is the default methodology. AI applies domain-driven design principles during decomposition, creating bounded contexts, aggregates, and domain models. Extensible via bolt types for BDD, TDD, or custom flows.
