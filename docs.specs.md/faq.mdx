...
<AccordionGroup>
  <Accordion title="What is specs.md?">
    specs.md is an AI-native development framework with pluggable flows for every use case. It provides markdown-based agents that work with your favorite AI coding tools (Claude Code, Cursor, GitHub Copilot) to guide software development.
  ...
  <Accordion title="Which flow should I choose?">
    ...
    **Quick decision:**
    ...
    [Detailed comparison →](/architecture/choose-flow)
  </Accordion>

  <Accordion title="What is FIRE flow?">
    ...
    [Learn more about FIRE →](/fire-flow/overview)
  </Accordion>
...
<AccordionGroup>
  <Accordion title="What are FIRE's execution modes?">
    ...
    [Learn more about execution modes →](/fire-flow/execution-modes)
  </Accordion>

  <Accordion title="How does FIRE handle brownfield projects?">
    ...
    [Learn more about brownfield support →](/fire-flow/monorepo-support)
  </Accordion>

  <Accordion title="How does FIRE support monorepos?">
    ...
    [Learn more about monorepo support →](/fire-flow/monorepo-support)
  </Accordion>

  <Accordion title="What are walkthroughs in FIRE?">
  ...
  <Accordion title="When should I NOT use FIRE?">
    ...
    [Flow comparison →](/architecture/choose-flow)
  </Accordion>
</AccordionGroup>
