...
Specs: `docs/specsmd/intents/001-unified-bolt-flow/work-items/*.md` and `docs/specsmd/standards/nlspec.md`. The flow contract, once landed, is the single source for locations, status tokens, and the ceremony matrix.
...
**Files/components affected:** evals/, .github/workflows/ or a test in src/__tests__ that enforces holdout isolation, docs/specsmd/intents/001-unified-bolt-flow/work-items/000-flow-evals.md
...
**Files/components affected:** plugins/specsmd/skills/flow-runtime/, src/__tests__/unit/unified/, docs/specsmd/intents/001-unified-bolt-flow/work-items/001-flow-schema.md, docs/specsmd/intents/001-unified-bolt-flow/work-items/002-recipe-catalog.md, docs/specsmd/intents/001-unified-bolt-flow/work-items/003-state-scripts.md
...
**Files/components affected:** plugins/specsmd/skills/flow-runtime/scripts/validate-integrity.cjs, plugins/specsmd/skills/flow-runtime/SKILL.md, src/__tests__/unit/unified/integrity.test.ts, docs/specsmd/intents/001-unified-bolt-flow/work-items/004-integrity-validator.md
...
**Files/components affected:** plugins/specsmd/skills/, src/__tests__/plugins-validation.test.ts, docs/specsmd/intents/001-unified-bolt-flow/work-items/005-planning-skills.md, docs/specsmd/intents/001-unified-bolt-flow/work-items/006-execution-skills.md, docs/specsmd/intents/001-unified-bolt-flow/work-items/007-navigator-status.md
...
**Files/components affected:** plugins/specsmd/skills/specsmd-init/, plugins/specsmd/skills/flow-runtime/references/standards/, plugins/specsmd/skills/flow-runtime/scripts/, src/__tests__/unit/unified/standards.test.ts, docs/specsmd/intents/001-unified-bolt-flow/work-items/008-standards-system.md
...
**Files/components affected:** plugins/specsmd/skills/flow-runtime/, plugins/specsmd/skills/using-specsmd/SKILL.md, plugins/specsmd/skills/specsmd-status/SKILL.md, src/__tests__/unit/unified/memory.test.ts, docs/specsmd/intents/001-unified-bolt-flow/work-items/011-memory-lifecycle.md
...
**Files/components affected:** plugins/specsmd/skills/, src/__tests__/unit/unified/release.test.ts, docs/specsmd/intents/001-unified-bolt-flow/work-items/012-slim-ops.md
...
**Files/components affected:** plugins/specsmd/, plugins/.claude-plugin/marketplace.json, .claude-plugin/marketplace.json, src/__tests__/plugins-validation.test.ts, docs/specsmd/intents/001-unified-bolt-flow/work-items/009-plugin-packaging.md
...
**Files/components affected:** docs.specs.md/v2/, docs.specs.md/docs.json, docs.specs.md/index.mdx, docs/specsmd/intents/001-unified-bolt-flow/work-items/010-v2-docs.md
