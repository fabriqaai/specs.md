---
name: monitor
description: Use when the user asks to set up monitoring, observability, alerting, dashboards, SLOs, or runbooks for a deployed unit during the AI-DLC Operations phase. Configures metrics, logging, and alerts, then documents the configuration.
license: MIT
metadata:
  version: "1.0.0"
  flow: aidlc
...
### Suggested Next Step
→ **operations** - Monitor for 24-48 hours, then return for adjustments
