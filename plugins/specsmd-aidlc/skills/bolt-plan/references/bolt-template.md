...
**Type**: {type name}
**Definition**: `references/bolt-types/{type}.md` (bundled with the `bolt-start` skill)
...
**Type**: DDD Construction Bolt
**Definition**: `references/bolt-types/ddd-construction-bolt.md` (bundled with the `bolt-start` skill)
