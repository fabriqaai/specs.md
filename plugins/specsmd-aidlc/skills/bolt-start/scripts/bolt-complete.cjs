 ...
 * └──────────────────────────────────────────────────────────────────────────┘
 *
 *   From the bolt-start skill (Step 10), run from the project root:
 *
 *     node <bolt-start-skill-dir>/scripts/bolt-complete.cjs 016-analytics-tracker
 *
 *   With optional stage name:
 *
 *     node <bolt-start-skill-dir>/scripts/bolt-complete.cjs 016-analytics-tracker --last-stage test
 *
 * ═══════════════════════════════════════════════════════════════════════════════
 */
...
for (let i = 0; i < args.length; i++) {
    if (args[i] === '--last-stage') {
        lastStage = args[i + 1] || null;
        i++;
    } else if (args[i].startsWith('--last-stage=')) {
        lastStage = args[i].slice('--last-stage='.length) || null;
    } else {
        positional.push(args[i]);
    }
}

const boltId = positional[0];
