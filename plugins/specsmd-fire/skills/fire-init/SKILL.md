---
name: fire-init
description: Use when starting FIRE in a project that has no `.specs-fire/state.yaml`, or when the user asks to initialize or set up FIRE. Detects the workspace and creates the FIRE workspace and standards.
license: MIT
metadata:
  version: "1.0.0"
  flow: fire
...
<triggers>
  - FIRE is started on an uninitialized project
...
<flow>
  ...
  <step n="6" title="Create Structure">
    ...
    <action>Generate standards using the bundled templates in this skill's `references/` directory:</action>
    <substep>constitution.md — references/constitution.md.hbs</substep>
    <substep>tech-stack.md — references/tech-stack.md.hbs</substep>
    <substep>coding-standards.md — references/coding-standards.md.hbs</substep>
    <substep>testing-standards.md — references/testing-standards.md.hbs</substep>
    <substep>system-architecture.md — references/system-architecture.md.hbs</substep>
...
<output_artifacts>
  ...
  | Constitution | `.specs-fire/standards/constitution.md` | `references/constitution.md.hbs` |
  | Tech Stack | `.specs-fire/standards/tech-stack.md` | `references/tech-stack.md.hbs` |
  | Coding Standards | `.specs-fire/standards/coding-standards.md` | `references/coding-standards.md.hbs` |
  | Testing Standards | `.specs-fire/standards/testing-standards.md` | `references/testing-standards.md.hbs` |
  | System Architecture | `.specs-fire/standards/system-architecture.md` | `references/system-architecture.md.hbs` |
