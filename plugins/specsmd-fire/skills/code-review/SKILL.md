---
name: code-review
description: Use after tests pass in a FIRE run, or when the user asks to review code written during a run. Auto-fixes mechanical issues and presents the rest for approval.
license: MIT
metadata:
  version: "1.0.0"
  flow: fire
...
<flow>
  ...
  <step n="5" title="Generate Review Report">
    <action>Create review report using the bundled template `references/review-report.md.hbs` in this skill's directory</action>
