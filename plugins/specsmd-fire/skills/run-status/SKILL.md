---
name: run-status
description: Use when the user asks about the current FIRE run, its progress, or what has changed so far. Shows the active run's work item, mode, duration, and files changed.
license: MIT
metadata:
  version: "1.0.0"
  flow: fire
